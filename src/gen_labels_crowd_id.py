...
if __name__ == '__main__':
    data_val = '/media/ioe60/sdb4t/Mjb/data/crowdhuman/images/val'
    label_val = '/media/ioe60/sdb4t/Mjb/data/crowdhuman/labels_with_ids/val'
    ann_val = '/media/ioe60/sdb4t/Mjb/data/crowdhuman/annotation_val.odgt'
    data_train = '/media/ioe60/sdb4t/Mjb/data/crowdhuman/images/train'
    label_train = '/media/ioe60/sdb4t/Mjb/data/crowdhuman/labels_with_ids/train'
    ann_train = '/media/ioe60/sdb4t/Mjb/data/crowdhuman/annotation_train.odgt'
